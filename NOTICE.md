...
The pixel-style external-service and theme icon geometry is adapted from
[HackerNoon's Pixel Icon Library](https://github.com/hackernoon/pixel-icon-library),
licensed under CC BY 4.0. Attribution is retained in the relevant component
markup and this notice. See the upstream project for its complete license and
attribution terms.
